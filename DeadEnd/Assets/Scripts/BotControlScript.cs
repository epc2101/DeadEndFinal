...
public class BotControlScript : MonoBehaviour
{
	...
	static int waveState = Animator.StringToHash("Layer2.Pickup");
	...
	void FixedUpdate ()
	{
		...
		if(layer2CurrentState.nameHash == waveState) Debug.Log("True");else Debug.Log ("False");
		...
		else if (layer2CurrentState.nameHash == idlelState_L2)
		{
